...
import tabian.com.example.igtest.Login.LoginActivity;
import tabian.com.example.igtest.Utils.BottomNavigationViewHelper;
import tabian.com.example.igtest.Utils.FirebaseMethods;
import tabian.com.example.igtest.Utils.MainFeedListAdapter;
import tabian.com.example.igtest.Utils.SectionsPagerAdapter;
import tabian.com.example.igtest.Utils.UniversalImageLoader;
import tabian.com.example.igtest.Utils.ViewCommentsFragment;
import tabian.com.example.igtest.models.Photo;
import tabian.com.example.igtest.opengl.AddToStoryDialog;
import tabian.com.example.igtest.opengl.NewStoryActivity;
...
public class HomeActivity extends AppCompatActivity implements
    ...
    public void onLoadMoreItems() {
        ...
        tabian.com.example.igtest.Home.HomeFragment fragment = (HomeFragment)getSupportFragmentManager()
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton video_btn = (ImageButton) findViewById(R.id.video_btn);

        video_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(HomeActivity.this,VideosActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_ADD_NEW_STORY) {
            ...
            if (resultCode == RESULT_ADD_NEW_STORY) {
                ...
                final tabian.com.example.igtest.Home.HomeFragment fragment = (HomeFragment) getSupportFragmentManager().findFragmentByTag("android:switcher:" + R.id.viewpager_container + ":" + 1);
                if (fragment != null) {
